...
export const updateWeatherMarkup = (url, store) => {
    ...
    <div class="weather__location">
        <div class="weather__location__city">${store.name}, ${store.country}</div>
        <div class="weather__location__temperature">${Math.round(store.temp - 273)}&#176</div>
    </div>
    ...
    <div class="weather__main">
        <div class="weather__main-conditions conditions">
            ...
            <div class="conditions__description">${store.description}</div>
        </div>
            ...
            <ul class="info__list">
                <li class="info__item item">
                    <div class="item__info">
                        <div class="item__title">${(store.speed).toFixed(1)} m/s</div>
                        <div class="item__value">wind speed</div>
                    </div>
                    <img src="./images/wind.svg" alt="wind" class="item__img">
                </li>
                <li class="info__item item">
                    <div class="item__info">
                    ...
                    <img src="./images/humidity.svg" alt="wind" class="item__img">
                </li>
                <li class="info__item item">
                    <div class="item__info">
                    ...
                    <img src="./images/cloudcover.svg" alt="wind" class="item__img">
                </li>
                <li class="info__item item">
                    <div class="item__info">
                    ...
                    <img src="./images/pressure.svg" alt="wind" class="item__img">
                </li>
            </ul>
        </div>
    </div>
